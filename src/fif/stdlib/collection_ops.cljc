...
(defn import-stdlib-collection-ops
  ...
  (-> sm
      ...
      (stack/set-word 'cons (wrap-function-with-arity 2 cons))
      ...
      (stack/set-word 'drop-last (wrap-function-with-arity 1 drop-last))
      (stack/set-word 'drop-last-n (wrap-function-with-arity 2 drop-last))
      ...
      (stack/set-word 'interleave3 (wrap-function-with-arity 3 interleave))
      (stack/set-word 'interleave4 (wrap-function-with-arity 4 interleave))
      ...
      (stack/set-word 'take-last (wrap-function-with-arity 2 take-last))
