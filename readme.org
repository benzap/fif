...
*fif* is a Stack-based Programming Language in Clojure(script). It is an
interpreted, extensible, sandboxed, and simple scripting language
based off of Forth.

You can try out fif online in the [[http://benzaporzan.me/fif-playground/][Fif Playground]]

I would like to note that one major tradeoff in the language syntax is
very limited parenthesis after invocation and the language creation is
...
* Installation
  ...
  *Clojure CLI/deps.edn*
  ...
  fif {:mvn/version "0.3.0-SNAPSHOT"}
  ...
  *Gradle*
  ...
  compile 'fif:fif:0.3.0-SNAPSHOT'
