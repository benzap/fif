...
* Native Executable
  ...
  The resulting binary starts incredibly fast (<20ms), and can be used for
  writing scripts for manipulating EDN data structures
  ...
  Using fif as a commandline tool has the advantage of directly
